    ...
    $.fn.uploadFile = function (options) {
	   ...
	   this.startUpload = function () {
        ...
        this.createProgress = function (filename,filepath,filesize) {
            ...
            if(s.showFileIcon && !s.showFileCounter)
                fileNameStr = "<span class=\"glyphicon glyphicon-file\" aria-hidden=\"true\"></span>&nbsp;" + filename;
            
            if(s.showFileSize)
				fileNameStr += " <span class=\"counter counter-red\">"+getSizeStr(filesize)+"</span>";
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for(var i = 0; i < files.length; i++) {
                ...
                if(s.showFileIcon && !s.showFileCounter)
                    fileNameStr = "<span class=\"glyphicon glyphicon-file\" aria-hidden=\"true\"></span>&nbsp;" + files[i].name;

				if(s.showFileSize)
				fileNameStr += " <span class=\"counter counter-red\">"+getSizeStr(files[i].size)+"</span>";
            ...
            fileInput.change(function () {
                ...
                if(s.serialize && feature.fileapi && feature.formdata) //use HTML5 support and split file submission
                {
                    ...
                    for(var i = 0; i < fileArray.length; i++) {
                        ...
                        if(s.showFileIcon && !s.showFileCounter)
                            fileList = "<span class=\"glyphicon glyphicon-file\" aria-hidden=\"true\"></span>&nbsp;" + fileArray[i] + "<br>";
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.abort.addClass("ajax-file-upload-button").addClass("ajax-file-upload-red");
            this.done.addClass("ajax-file-upload-button").addClass("ajax-file-upload-green");
			this.download.addClass("ajax-file-upload-button").addClass("ajax-file-upload-green");
            this.cancel.addClass("ajax-file-upload-button").addClass("ajax-file-upload-red");
            this.del.addClass("ajax-file-upload-button").addClass("ajax-file-upload-red");
